            ...
            switch (estado) {
                case 0:
                    if (c == ' ' || c == '\t' || c == '\n' || c == '\r') { // caracteres de espaço em branco ASCII
                        ...
                        lexema.append(c);
                        throw new ExceptionToken("Erro: token inválido \"" + lexema + "\"");
                    }
                    break;
                case 1:
                    if (this.isLetra(c) || this.isDigito(c) || c == '_') {
                        ...
                        reservada = reservada + c;
                        if (this.isReservada(reservada)) {
                            lexema.append(reservada);
                            estado = 7;
                        }
                    } else {
                        this.back();
                ...
                case 3:
                    if (this.isDigito(c)) {
                        ...
                        throw new ExceptionToken("Erro: número float inválido \"" + lexema + "\"");
                    }
                    break;
                case 4:
                    if (this.isDigito(c)) {
                ...
                case 7:
                    if (this.isLetra(c) || this.isDigito(c) || c == ' ' || c == '\t' || c == '=' || c == '+' || c == '-' || c == '*' || c == '/' || c == ')' || c == '(' || c == '{' || c == '}' || c == ',' || c == '_' || c == '.' || c == ';') {
                        ...
                        throw new ExceptionToken("Erro: não teve fecha aspa dupla pra finalizar o tipo string \"" + lexema + "\"");
                    } else if (c == '"') {
                        lexema.append(c);
                ...
                case 10:
                    if (c == '\n' || c == '\t' || c == ' ' || c == '\r') {
                        ...
                        throw new ExceptionToken("Erro: não foi aceito nas regras do relacional \"" + lexema + "\"");
                    }
